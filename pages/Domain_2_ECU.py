...
st.image(
    "https://github.com/StepanErshov/Convert2DBC/blob/main/pages/excel_split_example.png?raw=true",
    caption="Domain Excel → ECU Excel",
)
...
if uploaded_file:
    try:
        ...
        if selected_ecus and st.button("🖊 Export selected ECUs"):
            ...
            st.success(
                f"Export completed for {len(selected_ecus)} ECUs. All files are ready for download in one archive."
            )
